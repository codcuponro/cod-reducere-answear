...
Instalează `cod-reducere-answear` prin NPM:
...
```javascript
var codes = require('cod-reducere-answear')

console.log(codes)

// [
//   {
//     site: 'https://www.answear.ro',
//     cod_reducere: 'ANSWEAR10',
...
Cod-reducere-answear a fost creat de echipa de la [Cuponescu](https://cuponescu.ro/) pentru a ajuta cu testarea.
